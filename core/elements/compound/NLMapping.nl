...
country="GB";
		...
		country="AW";
	else if (/Åland\s*Islands/i.exec(line))
		country="AX";
		...
		country="BN";
	else if (/Bolivia\s*(Plurinational\s*State\s*of)/i.exec(line))
		country="BO";
	else if (/Bonaire,\s*Sint\s*Eustatius\s*and\s*Saba/i.exec(line))
		country="BQ";
		...
		country="CC";
	else if (/Congo\s*(the\s*Democratic\s*Republic\s*of\s*the)/i.exec(line))
		country="CD";
	else if (/Central\s*African\s*Republic/i.exec(line))
		country="CF";
	else if (/Congo/i.exec(line))
		country="CG";
	else if (/Switzerland/i.exec(line))
		country="CH";
	else if (/Côte\s*d'Ivoire/i.exec(line))
		country="CI";
		...
		country="CU";
	else if (/Cabo\s*Verde/i.exec(line))
		country="CV";
		...
		country="FJ";
	else if (/Falkland\s*Islands\s*(Malvinas)/i.exec(line))
		country="FK";
	else if (/Micronesia\s*(Federated\s*States\s*of)/i.exec(line))
		country="FM";
		...
		country="GR";
	else if (/South\s*Georgia\s*and\s*the\s*South\s*Sandwich\s*Islands/i.exec(line))
		country="GS";
		...
		country="HK";
	else if (/Heard\s*Island\s*and\s*McDonald\s*Islands/i.exec(line))
		country="HM";
	else if (/Honduras/i.exec(line))
		country="HN";
	else if (/Croatia/i.exec(line))
		country="HR";
		...
		country="KN";
	else if (/Korea\s*(the\s*Democratic\s*People's\s*Republic\s*of)/i.exec(line))
		country="KP";
	else if (/Korea\s*(the\s*Republic\s*of)/i.exec(line))
		country="KR";
		...
		country="MC";
	else if (/Moldova\s*(the\s*Republic\s*of)/i.exec(line))
		country="MD";
	else if (/Montenegro/i.exec(line))
		country="ME";
	else if (/Saint\s*Martin\s*(French\s*part)/i.exec(line))
		country="MF";
	else if (/Madagascar/i.exec(line))
		country="MG";
	else if (/Marshall\s*Islands/i.exec(line))
		country="MH";
	else if (/North\s*Macedonia/i.exec(line))
		country="MK";
	else if (/Mali/i.exec(line))
		country="ML";
	else if (/Myanmar/i.exec(line))
		country="MM";
	else if (/Mongolia/i.exec(line))
		country="MN";
	else if (/Macao/i.exec(line))
		country="MO";
		...
		country="PL";
	else if (/Saint\s*Pierre\s*and\s*Miquelon/i.exec(line))
		country="PM";
	else if (/Pitcairn/i.exec(line))
		country="PN";
	else if (/Puerto\s*Rico/i.exec(line))
		country="PR";
	else if (/Palestine,\s*State\s*of/i.exec(line))
		country="PS";
		...
		country="SG";
	else if (/Saint\s*Helena,\s*Ascension\s*and\s*Tristan\s*da\s*Cunha/i.exec(line))
		country="SH";
	else if (/Slovenia/i.exec(line))
		country="SI";
	else if (/Svalbard\s*and\s*Jan\s*Mayen/i.exec(line))
		country="SJ";
	else if (/Slovakia/i.exec(line))
		country="SK";
		...
		country="SV";
	else if (/Sint\s*Maarten\s*(Dutch\s*part)/i.exec(line))
		country="SX";
	else if (/Syrian\s*Arab\s*Republic/i.exec(line))
		country="SY";
	else if (/Eswatini/i.exec(line))
		country="SZ";
		...
		country="TK";
	else if (/Timor-Leste/i.exec(line))
		country="TL";
		...
		country="TO";
	else if (/Türkiye/i.exec(line))
		country="TR";
	else if (/Trinidad\s*and\s*Tobago/i.exec(line))
		country="TT";
	else if (/Tuvalu/i.exec(line))
		country="TV";
	else if (/Taiwan\s*(Province\s*of\s*China)/i.exec(line))
		country="TW";
	else if (/Tanzania,\s*the\s*United\s*Republic\s*of/i.exec(line))
		country="TZ";
	else if (/Ukraine/i.exec(line))
		country="UA";
	else if (/Uganda/i.exec(line))
		country="UG";
	else if (/United\s*States\s*Minor\s*Outlying\s*Islands/i.exec(line))
		country="UM";
		...
		country="UZ";
	else if (/Holy\s*See/i.exec(line))
		country="VA";
	else if (/Saint\s*Vincent\s*and\s*the\s*Grenadines/i.exec(line))
		country="VC";
	else if (/Venezuela\s*(Bolivarian\s*Republic\s*of)/i.exec(line))
		country="VE";
	else if (/Virgin\s*Islands\s*(British)/i.exec(line))
		country="VG";
	else if (/Virgin\s*Islands\s*(U.S.)/i.exec(line))
		country="VI";
	else if (/Viet\s*Nam/i.exec(line))
		country="VN";
